...
<div class="container">
    <h3>Cadastro ou Alteração de Usuários</h3>
        ...
        <form method="post">         
        <button type="submit" name="consultarusuario">Consultar por Usuário</button><br><br>
...
$sql = "INSERT INTO bancousuario (codigo, usuario, senha, perfil) VALUES ('$codigo', '$usuario', '$senha', '$perfil')";
  
// Executa a consulta
if ($conn->query($sql) === TRUE) {
    echo "<h4>Cadastro realizado com sucesso!</h4><div class='card'>";
    echo "<h4>Último usuário inserido!</h4><div class='card'>$usuario</div>";
    //echo "Cadastro realizado com sucesso!<br>";
    //echo "Último Usuário inserido:  $usuario<br>";
} else {
    echo "<h4>Erro ao cadastrar: " . $conn->error;
}
...
$conn->close();
    ...
    if(isset($_POST['atualizarUsuario'])) {
        ...
        //if(isset($_POST['codigo'])) {
          $sql = "SELECT * FROM bancousuario WHERE codigo = '$codigo' ";
          $result = $conn->query($sql);
          ...
          if ($result->num_rows > 0) {
           //echo "usuário já existe no banco de dados:"; 
            ...
            $sql = "UPDATE bancousuario SET codigo='$codigo', usuario='$usuario', senha='$senha', perfil='$perfil' WHERE codigo='$codigo'";
            //echo "Registro atualizado com sucesso!<br> Último usuário atualizado: " . $usuario . "<br>";           
          
      if ($conn->query($sql) === TRUE) {
        
       echo "<h4>Registro atualizado com sucesso!</h4><div class='card'>";
       //echo "Registro atualizado com sucesso!"; 
       //echo "Último Usuário atualizado: " . $usuario . "<br>";
        } else {      
     ...
     $perfil = $_POST['perfil'];  
      ...
      $sql = "DELETE FROM bancousuario WHERE codigo = $codigo";

      // Executa a consulta
      if ($conn->query($sql) === TRUE) {
          echo "<h4>Registro com usuário: $usuario foi excluído com sucesso!</h4><div class='card'>";
          //echo "Registro com Usuário: $usuario, foi excluído com sucesso!";
      } else {
