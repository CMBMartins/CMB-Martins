...
<head>
    <meta charset="UTF-8">
    <title>Cálculos Elétricos </title>
...
<div class="container">		
        ...
        <!--<a href="PaginaPessoal.php">VOLTAR<<</a><br><br>-->
			</div>
			...
			<div class="col align-self-center">
				<h1 class="text-center">Cálculo de Potência de Luz e Tomadas</h1>
...
<div class="container mt-5">
		...
		<form method="post" action="">
			...
			<button type="submit" class="btn btn-primary">Calcular a Potência de Luz em VA</button>
		</form>
		<?php
		if(isset($_POST['num1'])) 
		 { 		
